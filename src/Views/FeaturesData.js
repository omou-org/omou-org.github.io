...
const FeaturesData = [
    {
        ...
        description: "Omou provides an easy way for admins to browse all available tutoring courses with detailed descriptions and register students quickly.",
        content: () => (<div>
                  <span style={{fontWeight: "bold", fontSize: "18px", fontFamily:"Roboto, sans-serif"}}>Tutoring Course Information All On One Surface</span>
          ...
          <span style={{fontWeight: "bold", fontSize: "18px", fontFamily:"Roboto, sans-serif"}}>Find Courses Quickly for Easy Registration</span> 
          <ul style={{textAlign: "left", lineHeight: "30px"}}>
            <li>Filter classes by instructor(s), subject(s), academic grade level(s)</li>
    ...
    },
    {
        ...
        description: "Never worry about mix-ups with payment confirmation! Omou can be your single source of truth with automated invoice tracking and much more.",
        content: () => (<div>
            <ul style={{textAlign: "left", fontWeight: "bold", fontSize: "18px", fontFamily:"Roboto, sans-serif", lineHeight: "37px"}}>
            <li>Filter classes by instructor(s), subject(s), academic grade level(s)</li>
            <li>Register by tutoring subject</li>
            <li>Register by parent</li>
            </ul>
    ...
    },
    {
        ...
        description: "Scheduling personal tutoring classes with specific tutors can be tricky. Omou lets you quickly see which tutors are available at what time.",
        content: () => (<div>
            <ul style={{textAlign: "left", fontWeight: "bold", fontSize: "18px", fontFamily:"Roboto, sans-serif", lineHeight: "37px"}}>
    ...
    },
    {
        ...
        description: "Omou allows you to create user profiles for admins, students, and parents.",
        content: () => (<div>
            <ul style={{textAlign: "left", fontWeight: "bold", fontSize: "18px", fontFamily:"Roboto, sans-serif", lineHeight: "37px"}}>
